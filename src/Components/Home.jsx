    ...
    <div className="container mx-auto flex flex-col md:flex-row items-center py-10 md:my-22">
      <div className="flex flex-col w-full lg:w-1/2 justify-center items-start pt-12 pb-24 px-6">
        ...
        <p className="leading-normal mb-4 text-gray-300">
          ...
          eveniet. Atque, veritatis sit. Nam, voluptates nihil vitae enim dicta
          consequuntur in alias, repudiandae, modi necessitatibus earum quia
          reiciendis iusto dolores.
        </p>
      ...
      <div className="w-full lg:w-1/2 lg:py-6 text-center">
        <img className="fill-current text-gray-900  mx-auto" src={burgerImg} alt="burger"  viewBox="0 0 20 20"/>
      </div>
    </div>
    </div>
  );
